...
<div data-css-class="woof_sku_search_container" class="woof_sku_search_container woof_container woof_container_woof_sku <?php echo WOOF_HELPER::generate_container_css_classes('by_sku') ?>">
    ...
    <div class="woof_container_inner">
        ...
        ?>" data-autocomplete="<?php echo intval($autocomplete) ?>" data-autocomplete_items="<?php echo intval($autocomplete_items) ?>">
            ...
            <?php endif; ?>
			<input type="hidden" class="woof_sku_search_nonce" value="<?php echo wp_create_nonce('sku_search_nonce')?>">
        </div>
