...
<?php
         ...
         if (isset($images) && $images) {
             $cat_id 		= 	$images;
             $cat_count      =   hara_get_product_count_of_category($tab['category']);
			...
			<div class="item">
				...
				<div class="item-cat">
					...
					<a class="cat-name" href="<?php echo esc_url($cat_link); ?>">
						...
						<span class="count-item">(<?php echo trim($cat_count).' '.esc_html__('products', 'hara'); ?>)</span>
					</a>
