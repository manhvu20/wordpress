...
if (! defined('ABSPATH') || function_exists('Hara_Elementor_List_Categories_Product')) {
 ...
 * @since 1.0.0
 */
class Hara_Elementor_List_Categories_Product extends Hara_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Hara List Categories Product', 'hara');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('List Categories Product', 'hara'),
            ]
        );
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of categories', 'hara'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Number of categories to show ( -1 = all )', 'hara'),
                'min'  => -1,
                'default' => 6,
            ]
        );
                        ...
                        <?php
                            ...
                            echo '<div class="cat-content">'; ?>
                                    ...
                                    <?php
                                        if ($show_count === 'yes') {
                                            ?>
                                            <span class="count-item"><?php echo trim($count).' '.esc_html__('products', 'hara'); ?></span>
                                            <?php
                                        } ?>
...
$widgets_manager->register(new Hara_Elementor_List_Categories_Product());
