...
if ( ! defined( 'ABSPATH' ) || function_exists('Hara_Elementor_Search_Canvas') ) {
...
class Hara_Elementor_Search_Canvas extends Hara_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Hara Search Canvas', 'hara');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Result', 'hara'),
        ...
        $this->add_control(
            'show_image_search',
            [
                'label'   => esc_html__('Show Image of Search Result', 'hara'),
        ...
        $this->add_control(
            'show_price_search',
            [
                'label'              => esc_html__('Show Price of Search Result', 'hara'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'search_type' => 'product',
    ...
    protected function _register_form_canvas() {
        ...
        $this->add_control(
            'search_type',
            [
                'label'              => esc_html__('Search Result', 'hara'),
                'type'               => Controls_Manager::SELECT,
                'default' => 'product',
                'options' => [
                    'product'  => esc_html__('Product','hara'),
                    'post'  => esc_html__('Blog','hara')
                ]
            ]
        );
        ...
        $this->add_control(
            'autocomplete_search',
            [
                'label'              => esc_html__('Auto-complete Search', 'hara'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => true,
            ]
        );
        $this->add_control(
            'placeholder_text',
            [
                'label'              => esc_html__('Placeholder Text', 'hara'),
                'type'               => Controls_Manager::TEXT,
                'default' => esc_html__('Search for products...','hara'),
            ]
        );
        $this->add_control(
            'vali_input_search',
            [
                'label'              => esc_html__('Text Validate Input Search', 'hara'),
                'type'               => Controls_Manager::TEXT,
                'default' => esc_html__('Enter at least 2 characters','hara'),
            ]
        );
        $this->add_control(
            'min_characters_search',
            [
                'label'              => esc_html__('Search Min Characters', 'hara'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Max Number of Search Results', 'hara'),
                'type'               => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function _register_button_search() {
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Search', 'hara'),
                'type' => Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        $this->add_control(
            'text_button_search',
            [
                'label'              => esc_html__('Button Search Text', 'hara'),
                'type'               => Controls_Manager::TEXT,
            ]
        );
        $this->add_control(
            'icon_button_search',
            [
                'label'              => esc_html__('Button Search Icon', 'hara'),
    ...
    protected function _register_category_search() {
        $this->add_control(
            ...
            [
                'label' => esc_html__('Categories Search', 'hara'),
                'type' => Controls_Manager::HEADING,
                'separator'    => 'before',
            ]
        );
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Enable Search in Categories', 'hara'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Search in Categories Text', 'hara'),
                'type'               => Controls_Manager::TEXT,
                'default' => esc_html__('All Categories','hara'),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Show count in Categories', 'hara'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => true,
                'condition' => [
                    'enable_categories_search' => 'yes'
    ...
    protected function register_style_search_canvas() {
        ...
        $this->add_control(
            'padding_search',
            [
                'label'     => esc_html__('Padding Icon Search', 'hara'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
                    '{{WRAPPER}} .btn-search-icon > i,
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Hover', 'hara'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Hover', 'hara'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    public function render_search_canvas() {
        ...
        $class_active_ajax = hara_switcher_to_boolean($autocomplete_search) ? 'hara-ajax-search' : '';
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-thumbnail' => hara_switcher_to_boolean($show_image_search),
                'data-appendto' => '.search-results-'.$_id,
                'data-price' => hara_switcher_to_boolean($show_price_search),
                        ...
                        <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" <?php echo $this->get_render_attribute_string( 'search_form' ); ?> >
                            <div class="form-group">
                                ...
                                <div class="search-results-wrapper">
                                    <div class="hara-search-results search-results-<?php echo esc_attr( $_id );?>" ></div>
                                </div>
                                ...
                                <div class="button-group input-group-addon">
                                    ...
                                    <?php if ( $enable_categories_search === 'yes' ): ?>
                                        <div class="select-category input-group-addon">
                                            <span class="category-title"><?php esc_html_e( 'Search in:', 'hara' ) ?></span>
...
$widgets_manager->register(new Hara_Elementor_Search_Canvas());
