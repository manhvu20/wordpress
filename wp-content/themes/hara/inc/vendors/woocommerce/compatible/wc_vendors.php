...
if (! function_exists('hara_tbay_wcv_vendor_shop')) {
    remove_action('woocommerce_after_shop_loop_item', array( 'WCV_Vendor_Shop', 'template_loop_sold_by' ), 9);
    function hara_tbay_wcv_vendor_shop()
    {
    ...
    add_action('hara_woo_after_shop_loop_item_caption', 'hara_tbay_wcv_vendor_shop', 5);
    add_action('hara_woo_list_price', 'hara_tbay_wcv_vendor_shop', 10);
}

remove_action('woocommerce_product_meta_start', array( 'WCV_Vendor_Cart', 'sold_by_meta' ), 10, 2);
add_action('hara_woo_after_single_rating', array( 'WCV_Vendor_Cart', 'sold_by_meta' ), 10, 2);